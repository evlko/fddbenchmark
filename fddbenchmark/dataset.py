...
def download_pgbar(url: str, zfile_path: str, fname: str, chunk_size: int = 1024) -> None:
...
def read_csv_pgbar(csv_path: str, index_col: List[str], chunksize: int = 1024 * 100) -> pd.DataFrame:
